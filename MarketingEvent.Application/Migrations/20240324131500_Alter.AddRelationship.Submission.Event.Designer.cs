...
namespace MarketingEvent.Database.Migrations
{
    ...
    [Migration("20240324131500_Alter.AddRelationship.Submission.Event")]
    partial class AlterAddRelationshipSubmissionEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarketingEvent.Database.Submissions.Entities.Submission", b =>
                {
                    ...
                    b.HasOne("MarketingEvent.Database.Events.Entities.Event", "Event")
